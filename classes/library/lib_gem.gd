...
var example = {
	"debug" : {
	 	"debug" : {
			...
			color = "#FFFF22",
			on_weapon = {
				STR = [001, 001, 002, 002, 005,   005, 005, 005, 005, 005], #Attack
				INT = [001, 001, 002, 002, 005,   005, 005, 005, 005, 005], #Energy attack
	...
	"core" : {
		"speed" : {
			...
			color = "#5522FF",
			on_weapon = {
				STR = [-04, -04, -04, -04, -02,   -02, -02, -02, -02, -00],
				INT = [-04, -04, -04, -04, -02,   -02, -02, -02, -02, -00],
		...
		"endur" : {
			...
			color = "#FF22FF",
			on_weapon = {
				WIS = [-02, -02, -02, -02, -01,   -01, -01, -01, -01, -00],
				END = [002, 002, 003, 003, 004,   004, 004, 005, 005, 006],
			}
		},
		"wisdo" : {
			name = "Wisdom",
			...
			color = "#FF22FF",
			on_weapon = {
				END = [-02, -02, -02, -02, -01,   -01, -01, -01, -01, -00],
				WIS = [002, 002, 003, 003, 004,   004, 004, 005, 005, 006],
			}
		},
		"stren" : {
			name = "Strength",
			...
			color = "#FF2222",
			on_weapon = {
				STR = [002, 002, 003, 003, 004,   004, 004, 005, 005, 006],
				INT = [-02, -02, -02, -02, -01,   -01, -01, -01, -01, -00],
			}
		},
		"intel" : {
			name = "Intelligence",
			...
			color = "#0022FF",
			on_weapon = {
				INT = [002, 002, 003, 003, 004,   004, 004, 005, 005, 006],
				STR = [-02, -02, -02, -02, -01,   -01, -01, -01, -01, -00],
			}
		},
		"luck" : {
			name = "Luck",
		...
		"cut" : {
			...
			color = "#72E36E",
			on_weapon = {
				INT = [-001, -001, -002, -002, -005,   -005, -005, -005, -005, -005], #Attack
				STR = [+001, +001, +002, +002, +005,   +005, +005, +005, +005, +005], #Energy attack
				DUR = [002, 002, 003, 003, 005,   005, 006, 006, 007, 010], #Durability increase
				OFF = {
					DMG_CUT = [002, 002, 003, 003, 005,   005, 005, 006, 006, 008],
				},
...
func loaderWeaponBonus(val):
	if val == null:
		...
		var result = {}
		for i in ['WRD', 'DUR', 'CRI', 'STR', 'END', 'INT', 'WIS', 'AGI', 'LUC']:
			if i in val:
...
func loaderBodyBonus(val):
	if val == null:
		...
		var result = {}
		for i in ['MHP', 'MEP', 'STR', 'END', 'INT', 'WIS', 'AGI', 'LUC']:
			if i in val:
				result[i] = int(val[i])
		return result
