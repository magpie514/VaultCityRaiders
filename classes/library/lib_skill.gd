...
var example = {
	"core" : {
		"defend" : {
			...
			energyDMG = false,
			damageStat = core.stats.STAT.STR,
	...
	"story" : {
		...
		"thunswrd": {
			...
			fieldEffectMult = 2,
			energyDMG = true,
			damageStat = core.stats.STAT.INT,
	...
	"debug" : {
		...
		"barricad": {
			...
			effectStatBonus = {
				EFFSTAT_BASEMULT = {
					END = [020, 000, 000, 000, 000,   000, 000, 000, 000, 000],
		...
		"solidbun": {
			...
			effectStatBonus = {
				EFFSTAT_BASEMULT = {
					END = [120, 000, 000, 000, 000,   000, 000, 000, 000, 000],
				},
				EFFSTAT_RES = {
		...
		"nrgshild": {
			...
			effectStatBonus = {
				EFFSTAT_BASEMULT = {
					WIS = [120, 000, 000, 000, 000,   000, 000, 000, 000, 000],
				},
				EFFSTAT_RES = {
		...
		"overclck": {
			...
			effectStatBonus = {
				...
				EFFSTAT_BASEMULT = {
					STR = [020, 000, 000, 000, 000,   000, 000, 000, 000, 000],
					AGI = [020, 000, 000, 000, 000,   000, 000, 000, 000, 000],
					INT = [020, 000, 000, 000, 000,   000, 000, 000, 000, 000],
				},
			},
			effectDuration = 2,
			effectPriority = 3,
...
func initTemplate():
	return {
		...
		"damageStat" : { loader = LIBSTD_INT, default = core.stats.STAT.STR },
